    ...
    return (
        <>
            ...
            <Cardpopup trigger={cardClick} setTrigger={setCardClick} setSelectedTool={setSelectedTool}>
                    ...
                    <>
                        ...
                        <form action="" method="post">
                            ...
                            <div>
                                ...
                                <div className="formElementContainer right"><input type="file" name="3dviewer" /></div>
                            </div>
                            <div>
                                <div className="formElementContainer left"><label htmlFor="3dfiles">3D Files</label></div>
                                <div className="formElementContainer right"><input type="file" name="3dfiles" /></div>
                            </div>
                            <div>
                                <div className="formElementContainer left"><label htmlFor="tags">Tags</label></div>
                                <div className="formElementContainer right"><input type="text" name="tags" /></div>
                            </div>
                            <div>
                                <div className="formElementContainer left"><label htmlFor="styles">Styles</label></div>
                                <div className="formElementContainer right"><input type="text" name="styles" /></div>
                            </div>
                            <div>
                                <div className="formElementContainer center"><input type="submit" value="Upload" /></div>
                            </div>
                        </form>
                        </div>
                    </>
                )}
                {showOptions && selectedTool === 'image' && (
                    <>
                    <div className='customizationContainer'>
                    <form action="" method="post">
                        <div>
                            <div className="formElementContainer left"><label htmlFor="title">Image Title</label></div>
                            <div className="formElementContainer right"><input type="text" name="title" /></div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="formElementContainer right"><input type="file" name="imgviewer" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="imgfiles">Image Files</label></div>
                            <div className="formElementContainer right"><input type="file" name="imgfiles" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="tags">Tags</label></div>
                            <div className="formElementContainer right"><input type="text" name="tags" /></div>
                ...
                {showOptions && selectedTool === 'video' && (
                    <>
                    <div className='customizationContainer'>
                    <form action="" method="post">
                        <div>
                            <div className="formElementContainer left"><label htmlFor="title">Video Title</label></div>
                            <div className="formElementContainer right"><input type="text" name="title" /></div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="formElementContainer right"><input type="file" name="vidPreview" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="vidFiles">Video Files</label></div>
                            <div className="formElementContainer right"><input type="file" name="vidFiles" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="tags">Tags</label></div>
                            <div className="formElementContainer right"><input type="text" name="tags" /></div>
                ...
                {showOptions && selectedTool === 'audio' && (
                    <>
                    <div className='customizationContainer'>
                    <form action="" method="post">
                        <div>
                            <div className="formElementContainer left"><label htmlFor="title">Audio Title</label></div>
                            <div className="formElementContainer right"><input type="text" name="title" /></div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="formElementContainer right"><input type="file" name="audPreview" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="audFiles">Audio Files</label></div>
                            <div className="formElementContainer right"><input type="file" name="audFiles" /></div>
                        </div>
                        <div>
                            <div className="formElementContainer left"><label htmlFor="tags">Tags</label></div>
                            <div className="formElementContainer right"><input type="text" name="tags" /></div>
                ...
                {showOptions && selectedTool === 'job' && (
                     <>
                     <div className='customizationContainer'>
                     <form action="" method="post">
                         <div>
                             <div className="formElementContainer left"><label htmlFor="title">Job Title</label></div>
                             <div className="formElementContainer right"><input type="text" name="title" /></div>
                         </div>
                         <div>
                         ...
                         <div>
                             ...
                             <div className="formElementContainer right"><input type="text" name="clink" /></div>
                         </div>
                         <div>
                             <div className="formElementContainer left"><label htmlFor="poster">Job Poster</label></div>
                             <div className="formElementContainer right"><input type="file" name="poster" /></div>
                         </div>
                         <div>
                             <div className="formElementContainer left"><label htmlFor="tags">Tags</label></div>
                             <div className="formElementContainer right"><input type="text" name="tags" /></div>
                ...
                {showOptions && selectedTool === null && (
                    <h3 align="center">Please select option to upload</h3>
                )}
            </Cardpopup>
        </>
    )
