...
import ProfileRadiusPic from "./rhstudio_component/ProfileRadiusPic";
        ...
        <nav>
          <div className="navgation">
            ...
            <div className="navItems">
              <ul>
                <li
                  onClick={(e) => handleToolClick("customization")}
                  style={getToolStyles("customization")}
                >
                  <div className="icon-svg">
                ...
                <li
                  onClick={(e) => handleToolClick("dashboard")}
                  style={getToolStyles("dashboard")}
                >
                  <div className="icon-svg">
                ...
                <li
                  onClick={(e) => handleToolClick("uploads")}
                  style={getToolStyles("uploads")}
                >
                  <div className="icon-svg">
                ...
                <li
                  onClick={(e) => handleToolClick("comments")}
                  style={getToolStyles("comments")}
                >
                  <div className="icon-svg">
